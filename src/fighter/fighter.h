...
/* Macros do Guile */
#define NUM_GUILE_IDLE_FRAMES 5        
#define NUM_GUILE_RUNNING_FRAMES 5
#define NUM_GUILE_HI_KICK_FRAMES 3
#define NUM_GUILE_LO_KICK_FRAMES 2
#define NUM_GUILE_AIR_KICK_FRAMES 3
#define NUM_GUILE_HI_PUNCH_FRAMES 3
#define NUM_GUILE_LO_PUNCH_FRAMES 2
#define NUM_GUILE_AIR_PUNCH_FRAMES 3
#define NUM_GUILE_CROUCH_FRAMES 1
#define NUM_GUILE_BLOCK_FRAMES 1
